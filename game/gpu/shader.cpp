...
CGPUShader::CGPUShader(std::shared_ptr<CGPUDevice> device, SDL_Storage* storage, cstr name, SDL_GPUShaderStage stage)
	: CBaseGPUObject(device), m_stage(stage)
{
	...
	constexpr cstr STAGE_EXTENSIONS[] = {".vs", ".ps"};
